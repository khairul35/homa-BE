...
export class ContactService {
    ...
    async updateContact(contactId: number, updatedData: any) {
    ...
    async createBillingAddress(contactId: number, billingAddressData: any) {
    ...
    async createDeliveryAddress(contactId: number, deliveryAddressData: any) {
