...
export class ContactService {
    ...
    async createContact(body: Partial<CreateContact>) {
    ...
    async updateContact(contactId: number, updatedData: Partial<UpdateContact>) {
    ...
    async createContactPhoneNumber(contactId: number, phoneNumbers: Partial<CreateContactPhoneNumber>[]) {
    ...
    async createContactPrimaryPersons(contactId: number, primaryPersons: Partial<CreateContactPrimaryPerson>[]) {
    ...
    async createBillingAddress(contactId: number, billingAddressData: Partial<CreateBillingAddress>) {
    ...
    async createDeliveryAddress(contactId: number, deliveryAddressData: Partial<CreateDeliveryAddress>) {
